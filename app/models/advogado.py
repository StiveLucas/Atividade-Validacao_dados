...
class Advogado(Funcionario):
    def __init__(self, oab: str, cpf: str, rg: str, matricula: str, setor: Setor, salario: float, dataDeNascimento: str, estadoCivil: EstadoCivil, sexoNome: Sexo, sexoSigla: Sexo, id: str, nome: str, telefone: str, email: str, endereco: Endereco):
    ...
    def __str__(self):
        return(
            ...
            f" \nEstado Civil: {self.estadoCivil} \nSetor: {self.setor} \nEndereço do Advogado: {self.endereco}"
        )